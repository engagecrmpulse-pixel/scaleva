 ...
 * for the onboarding customer import; not a full RFC-4180 implementation.
 */
...
export function parseCustomersCsv(text: string): ImportedCustomer[] {
  ...
  // Build a column-name -> index map when a header is present.
...
/** Re-exported for callers that want to show the expected header. */
export { CSV_COLUMNS };
